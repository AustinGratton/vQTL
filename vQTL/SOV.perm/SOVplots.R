...
sig.plot1 = mean_var_plot_model_based(vQTLsub, 'Env', sig.loc[1], genotype.names = c('A','B'))
sig.plot2 = mean_var_plot_model_based(vQTLsub, 'Env', sig.loc[2], genotype.names = c('A','B'))
sig.plot3 = mean_var_plot_model_based(vQTLsub, 'Env', sig.loc[3], genotype.names = c('A','B'))
sig.plot4 = mean_var_plot_model_based(vQTLsub, 'Env', sig.loc[4], genotype.names = c('A','B'))
sig.plot5 = mean_var_plot_model_based(vQTLsub, 'Env', sig.loc[5], genotype.names = c('A','B'))
sig.plot6 = mean_var_plot_model_based(vQTLsub, 'Env', sig.loc[6], genotype.names = c('A','B'))
